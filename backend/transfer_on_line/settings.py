...
JEKO_SUCCESS_URL = os.environ.get('JEKO_SUCCESS_URL', 'https://transfert-online.site/api/payments/jeko/return/')
JEKO_ERROR_URL = os.environ.get('JEKO_ERROR_URL', 'https://transfert-online.site/api/payments/jeko/return/')
...
GATEWAY_MANAGER = {
    "LOW_BATTERY_THRESHOLD": int(os.environ.get("GATEWAY_LOW_BATTERY_THRESHOLD", "10")),
